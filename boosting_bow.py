...
train_tfidf = pd.read_csv('project_data/data/bag-of-words/bow.train.csv')
train_x_tfidf = train_tfidf.iloc[:, 1:]
train_y_tfidf = train_tfidf.iloc[:, 0]

test_tfidf = pd.read_csv('project_data/data/bag-of-words/bow.test.csv')
test_x_tfidf = test_tfidf.iloc[:, 1:]
test_y_tfidf = test_tfidf.iloc[:, 0]

eval_df_tfidf = pd.read_csv('project_data/data/bag-of-words/bow.eval.anon.csv')
